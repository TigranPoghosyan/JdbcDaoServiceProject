...
public class EmployeeService extends Utill implements EmployeeDao {
    ...
    public void add(Employee employee) throws SQLException {
        ...
        try {
            ...
            preparedStatement.setLong(5,employee.getAddresId());
    ...
    public List<Employee> getAll() throws SQLException {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                employee.setAddresId(resultSet.getLong("ADDRESS_ID"));
    ...
    public void update(Employee employee) throws SQLException {
        ...
        try {
            ...
            preparedStatement.setLong(4,employee.getAddresId());
